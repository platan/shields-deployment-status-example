    ...
    try {
        ...
        if (context.eventName === 'pull_request' 
            ...
            await octokit.issues.createComment({
              ...
              body: `(v2) This pull request was merged to [${pull_request.base.ref}](${repository.html_url}/tree/${pull_request.base.ref}) branch. This change is now waiting for deployment, which will usually happen within a few days. Stay tuned by joining our \`#ops\` channel on [Discord](https://discordapp.com/invite/HjJCwm5)!
